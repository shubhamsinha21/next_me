...
function Hero() {
  return (
    ...
    overflow-hidden mx-auto py-10 dark:bg-grid-white/[0.01]"
    >
      <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p
          className="mt-4 font-normal text-base 
           md:text-lg text-neutral-300 max-w-lg mx-auto"
        >
          A self taught Software Engineer flexible to Frontend development and
          Machine Learning.
        </p>
        <div className="mt-4">
          <Link href="/courses">
